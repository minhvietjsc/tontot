                    ...
                    <div class="col-xs-12">
                        <div class="page-title-box">
                            ...
                            <ol class="breadcrumb p-0 m-0">
                                ...
                                <li class="active"> Cài đặt xác minh bằng điện thoại di động</li>
                            </ol>
                    ...
                    <div class="col-md-12 col-xs-12 col-xxs-12">
                        <div class="panel panel-color panel-inverse">
                            <div class="panel-heading">
                                <h3 class="panel-title">Cài đặt xác minh bằng điện thoại di động</h3>
                            </div>
                                ...
                                <ul class="nav nav-tabs">
                                    <li class="active">
                                        <a href="#twilio_settings" data-toggle="tab" aria-expanded="false">
                                            ...
                                            <span class="hidden-xs">Cài đặt Twilio</span>
                                        </a>
                                    </li>
                                    ...
                                    <div class="tab-pane active" id="twilio_settings">
                                        <form method="post" action="{{ route('mobile_verify.store') }}" id="MobileSettings">
                                            ...
                                            <div class="form-group">
                                                <lable>Sid</lable>
                                                <input type="text" name="twilio_sid" value="{{ isset($mobile_verify)&& $mobile_verify->twilio_sid !='' ? $mobile_verify->twilio_sid : '' }}" class="form-control" placeholder="Nhập sid twilio của bạn" required >
                                            </div>
                                            <div class="form-group">
                                                <lable>Token</lable>
                                                <input type="text" name="twilio_token" value="{{ isset($mobile_verify)&& $mobile_verify->twilio_token !='' ? $mobile_verify->twilio_token : '' }}" class="form-control" placeholder="Nhập token twilio của bạn" required >
                                            </div>
                                            @if(isset($mobile_verify))
                                                <?php
