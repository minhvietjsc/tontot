        ...
        <div class="content">
            <div class="col-xs-12">
                <div class="page-title-box">
                    <h4 class="page-title">Thêm nhóm</h4>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="title" class="form-control" value="{{ ( isset($group) && $group->title != '')? $group->title: '' }}" id="title" placeholder="Tên nhóm" required >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
