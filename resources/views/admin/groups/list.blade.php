        ...
        <div class="content">
            <div class="col-xs-12">
                <div class="page-title-box">
                    <h4 class="page-title">Thêm nhóm trường</h4>
                    <ol class="breadcrumb p-0 m-0">
                        <li> <a href="{{ url('dashboard') }}">Dashboard</a></li>
                        <li class="active">Thêm nhóm trường</li>
                    </ol>
            ...
            <div class="col-xs-12">
                ...
                <div class="card-box">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <a href="{{ route('groups.create') }}" class="btn btn-primary btn-sm pull-right m-b-10" > Thêm nhóm mới  </a>
                        </div>
                        @if(count($groups) > 0)
                            ...
                            <div class="col-xs-12 bg-white">
                                <div class="portlet">
                                    <div class="portlet-heading bg-inverse">
                                        <h3 class="portlet-title" title="Tên nhóm">@if($val['icon']!='' || $val['image']!='')  {!! ($val['icon']!='')? '<i class="'.$val['icon'].'"></i>' : '<img src="'.asset('assets/images/groups_icons/'.$val['image'].'').'" height="38px" width="38px    ">' !!}   {{ ucwords($val['title']) }} <span class="label label-pink" title="Danh mục"> {{ $val['group_cat']['name'] }} </span> @else {{ ucwords($val['title']) }} <span class="label label-pink" title="Danh mục"> {{ $val['group_cat']['name'] }} </span> @endif </h3>
                                    ...
                                    <div id="group_{{$val['id']}}" class="panel-collapse collapse @if (session('id') && $val['id'] == session('id')) in @endif"  @if (session('id') && $val['id'] == session('id') ) aria-expanded="true" @else aria-expanded="false" style="height: 0px;" @endif>
                                        <div class="portlet-body">
                                            <!-- Button trigger modal -->
                                            <div class="col-md-12">
                                                <button type="button" class="btn btn-primary btn-sm pull-right m-b-10" onclick="$('#group_id').val({{$val['id']}});$('#category_id').val({{$val['category_id']}}); $('#newFieldTitleId strong').html('({{ ucwords($val['title']) }} -> {{ ucwords($val['group_cat']['name']) }} )')"  data-toggle="modal" data-target="#newFieldModal"> Thêm trường(field) mới  </button>
                                            </div>
                                            <div class="clearfix"></div>
                                            @if( count($val['group_fields']) > 0 )
                                                            ...
                                                            <form action="{{route('group_fields.store')}}" id="form_Group{{$value['id']}}" method="post" enctype="multipart/form-data">
                                                                ...
                                                                <div class="form-group">
                                                                    <div class="radio radio-info radio-inline">
                                                                        ...
                                                                        <label for="is_icon_{{ $value['id'] }}">Thêm Icon</label>
                                                                    </div>
                                                                    <div class="radio radio-inline">
                                                                        ...
                                                                        <label for="is_image_{{ $value['id'] }}">Thêm Ảnh </label>
                                                                    </div>
                                                                </div>
                                                                <div class="form-group @if($value['image'] != '') hidden @endif  " id="icon-div_{{ $value['id'] }}">
                                                                    <label for="">Icons:</label><br>
                                                                    <div class="btn-group">
                                                                        <button type="button" onclick="$('#modal_hidden_id').val({{ $value['id'] }})"  class="btn btn-default" value="" data-toggle="modal" data-target="#iconModal">Thêm Icon</button>
                                                ...
                                                @endforeach
                                                @else
                                                <p class="text-danger"> Bạn chưa thêm bất kỳ trường <strong> {{ ucwords($val['title']) }} </strong> cho nhóm! </p>
                                            @endif
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="newFieldTitleId">Thêm mới <strong class="text-info"></strong> trường</h4>
                </div>
                <div class="modal-body">
                    <form action="{{route('group_fields.store')}}" id="form_Group" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group" id="icon-div_0">
                            <label for="">Icons:</label><br>
                            <div class="btn-group">
                                <button type="button" onclick="$('#modal_hidden_id').val(0)"  class="btn btn-default" value="" data-toggle="modal" data-target="#iconModal">Thêm Icon</button>
                    ...
                    <div class="card-boxs">
                        ...
                        <section id="web-application">
                            ...
                            <div class="icon-list-demo row">
                                ...
                                <div class="col-md-2"><i class="fa fa-life-Lưur"></i><span class="hidden"> fa-life-Lưur </span>
                                </div>
                        ...
                        <section id="text-editor">
                            ...
                            <div class="row icon-list-demo">
                                ...
                                <div class="col-md-2"><i class="fa fa-Lưu"></i><span class="hidden"> fa-Lưu </span>
                                </div>
                ...
                $.ajax({
                    ...
                    success: function(result){
                        ...
                        if( data.msg == 'success' ){
                            ...
                            swal("Success!", "Đã thêm nhóm thành công.", "success");
