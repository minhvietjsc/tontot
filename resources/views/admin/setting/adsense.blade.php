            ...
            <div class="col-xs-12">
                <div class="page-title-box">
                    ...
                    <ol class="breadcrumb p-0 m-0">
                        ...
                        <li class="active"> Cài đặt Adsense </li>
                    </ol>
                    ...
                    <div class="row">
                        <div class="panel panel-color panel-inverse">
                            <div class="panel-heading">
                                <h3 class="panel-title">Cài đặt Adsense</h3>
                            </div>
                                    ...
                                    <div class="col-md-offset-1">
                                        <div class="form-group">
                                            ...
                                            <div class="checkbox checkbox-success m-b-10">
                                                ...
                                                <label for="home_ads" class="text-bold">Trang chủ adsense</label>
                                            </div>
                                            ...
                                            <div id="home_page_editor" class="{{ (isset($data->home_ads) && $data->home_ads == 0)? 'hidden' : '' }}">
                                                ...
                                                <div class=" m-b-10">
                                                    <div class="radio radio-info radio-inline">
                                                        ...
                                                        <label for="inlineRadio1"> Đặt trước form tìm kiếm  </label>
                                                    </div>
                                                    <div class="radio radio-info radio-inline">
                                                        <input type="radio" id="inlineRadio2" {{ ($data->home_ads_p == 'as')? 'checked' : '' }} value="as" name="home_ads_p" >
                                                        <label for="inlineRadio2"> Đặt sau form tìm kiếm </label>
                                                    </div>
                                                    <div class="radio radio-info radio-inline">
                                                        <input type="radio" id="inlineRadio3" {{ ($data->home_ads_p == 'r')? 'checked' : '' }} value="r" name="home_ads_p" >
                                                        <label for="inlineRadio3"> Đặt phía bên phải của trang</label>
                                                    </div>
                                                </div>

                                                <label>Mã Adsense</label>
                                            ...
                                            <div class="checkbox checkbox-success m-b-10">
                                                ...
                                                <label for="search_ads" class="text-bold">Tìm kiếm trang adsense</label>
                                            </div>
                                            ...
                                            <div id="search_page_editor" class="{{ (isset($data->search_ads) && $data->search_ads == 0)? 'hidden' : '' }}">
                                                ...
                                                <div class=" m-b-10">
                                                    <div class="radio radio-info radio-inline">
                                                        ...
                                                        <label for="inlineRadio4"> Đặt trước form tìm kiếm  </label>
                                                    </div>
                                                    <div class="radio radio-info radio-inline">
                                                        <input type="radio" id="inlineRadio5" {{ ($data->search_ads_p == 'as')? 'checked' : '' }} value="as" name="search_ads_p" >
                                                        <label for="inlineRadio5"> Đặt sau form tìm kiếm </label>
                                                    </div>
                                                    <div class="radio radio-info radio-inline">
                                                        <input type="radio" id="inlineRadio6" {{ ($data->search_ads_p == 'r')? 'checked' : '' }} value="r" name="search_ads_p" >
                                                        <label for="inlineRadio6"> Đặt phía bên phải của trang</label>
                                                    </div>
                                                </div>
                                                <label for="search_ads">Mã Adsense</label>
                                            ...
                                            <div class="checkbox checkbox-success m-b-10">
                                                ...
                                                <label for="profile_ads" class="text-bold">Trang hồ sơ adsense</label>
                                            </div>
                                            ...
                                            <div id="profile_page_editor" class="{{ (isset($data->profile_ads) && $data->profile_ads == 0)? 'hidden' : '' }}">
                                                ...
                                                <div class=" m-b-10">
                                                    ...
                                                    <div class="radio radio-info radio-inline">
                                                        ...
                                                        <label for="inlineRadio7">Sau header</label>
                                                    </div>
                                                    <div class="radio radio-info radio-inline">
                                                        <input type="radio" id="inlineRadio8" {{ ($data->profile_ads_p == 'r')? 'checked' : '' }} value="r" name="profile_ads_p" >
                                                        <label for="inlineRadio8"> Đặt phía bên phải của trang</label>
                                                    </div>
                                                </div>

                                                <label for="profile_ads">Mã Adsense</label>
                                            ...
                                            <div class="checkbox checkbox-success m-b-10">
                                                ...
                                                <label for="single_ads" class="text-bold">Thêm trang chi tiết adsense</label>
                                            </div>
                                            <div id="single_page_editor" class="{{ (isset($data->single_ads) && $data->single_ads == 0)? 'hidden' : '' }}">
                                                ...
                                                <div class=" m-b-10">
                                                    <div class="radio radio-info radio-inline">
                                                        ...
                                                        <label for="inlineRadio10">Sau header</label>
                                                    </div>
                                                    <div class="radio radio-info radio-inline">
                                                        <input type="radio" id="inlineRadio11" {{ ($data->single_ads_p == 'r')? 'checked' : '' }} value="r" name="single_ads_p" >
                                                        <label for="inlineRadio11"> Đặt phía bên phải của trang</label>
                                                    </div>
                                                </div>
                                                <label for="single_ads">Mã Adsense</label>
