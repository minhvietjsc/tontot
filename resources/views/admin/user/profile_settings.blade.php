            ...
            <div class="col-xs-12">
                <div class="page-title-box">
                    ...
                    <ol class="breadcrumb p-0 m-0">
                        ...
                        <li class="active"> Cài đặt hồ sơ </li>
                    </ol>
                    ...
                    <div class="row">
                            <div class="panel panel-color panel-inverse">
                                <div class="panel-heading">
                                    <h3 class="panel-title">Cài đặt hồ sơ</h3>
                                </div>
                                <div class="panel-body">
                                    <form class="form-horizontal" role="form" id="profile_Setting" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="name" class="form-control" value="{{ $user->name }}"  placeholder="Nhập họ tên"  required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="email" readonly disabled class="form-control" value="{{ $user->email }}" placeholder="Email" required>
                                            </div>
                                        </div>

                                        <div class="form-group">
                                            <label class="col-md-2 control-label">Mật khẩu:</label>
                                            <div class="col-md-10">
                                                <input type="text" name="password" class="form-control" value="{{ $user->plain_password }}"  placeholder="Nhập mật khẩu"  required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-2 control-label">Ảnh đại diện:</label>
                                            <div class="col-md-10">
                                                ...
                                                <button id="browse_profile" class="btn w-md btn-bordered btn-success waves-effect waves-ligh " type="button">Duyệt</button>
