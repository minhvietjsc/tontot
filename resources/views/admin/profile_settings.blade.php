            ...
            <div class="col-xs-12">
                ...
                <div class="page-title-box">
                    ...
                    <ol class="breadcrumb p-0 m-0">
                        ...
                        <li class="active"> Cài đặt thông tin Tài khoản </li>
                    ...
                    <div class="row">
                            ...
                            <div class="panel panel-color panel-inverse">
                                ...
                                <div class="panel-heading">
                                    ...
                                    <h3 class="panel-title">Cài đặt thông tin Tài khoản</h3>
                                    ...
                                    <form class="form-horizontal" role="form" id="profile_Setting" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <input type="text" name="name" class="form-control" value="{{ $user->name }}"  placeholder="Họ và tên"  required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-10">
                                                ...
                                                <input type="text" name="password" class="form-control" value="{{ $user->plain_password }}"  placeholder="Nhập mật khẩu"  required>
                    ...
                    success: function(result){
                        ...
                        if(result.msg == 2){
                            ...
                            swal({
                                ...
                                text: "Email đã được lưu thành công!",
