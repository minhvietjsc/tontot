        ...
        <div class="content">
            ...
            <div class="col-xs-12">
                <div class="page-title-box">
                    <h4 class="page-title">Trường(fields) tùy chỉnh</h4>
                    <ol class="breadcrumb p-0 m-0">
                        <li> <a href="{{ url('dashboard') }}">Dashboard</a></li>
                        <li class="active">Trường(fields) tùy chỉnh</li>
                    </ol>
                ...
                <div class="card-box">
                    <div class="row">
						<div class="btn-group pull-right m-b-10">
                            <button id="add_cfield" type="button" class="btn btn-primary waves-effect waves-light" aria-expanded="false">Thêm trường(field)</button>
						...
						<div class="col-xs-12 bg-white cfields-listing">
                                	...
                                	<div class="portlet">
                                        <div class="portlet-heading portlet-default">
                                            ...
                                            <div class="portlet-widgets">
                                                ...
                                                <a title="Xóa trường(field)" href="javascript:void(0)" class="delete-cfield" data-id="{{ $customfield['id'] }}"><i class="ion-close-round"></i></a>
                                            </div>
                                            <div class="clearfix"></div>
                                        </div>
                                        <div id="bg_default_{{ $customfield['id'] }}" class="panel-collapse collapse">
                                            <div class="portlet-body">
                                            	<form name="form_{{ $customfield['id'] }}" action="{{ route('customfields.store') }}" method="post" enctype="multipart/form-data">
                                            		...
                                            		<fieldset>
                                                        ...
                                                        <div class="form-group">
                                                            <div class="radio radio-info radio-inline">
                                                                ...
                                                                <label for="is_icon_{{ $customfield['id'] }}">Thêm Icon</label>
                                                            </div>
                                                            <div class="radio radio-inline">
                                                                ...
                                                                <label for="is_image_{{ $customfield['id'] }}">Thêm Ảnh </label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group" id="icon-div_{{ $customfield['id'] }}">
                                                            ...
                                                            <div class="btn-group">
                                                                ...
                                                                <button type="button" onclick="$('#modal_hidden_id').val({{ $customfield['id'] }})"  class="btn btn-default" value="" data-toggle="modal" data-target="#iconModal">Thêm Icons</button>
                                            			...
                                            			{{--@if (isset($customfield['options']) && $customfield['options'] && ($customfield['type'] == 'dropdown' || $customfield['type'] == 'radio'))--}}
                                            				...
                                            				<label for="options_{{ $customfield['id'] }}">Tùy chọn trường:</label>
                                            				<input id="options_{{ $customfield['id'] }}" name="options" type="text" value="{{ $customfield['options'] }}" class="form-control" />
                                            				<span class="help-block">Nhập các tùy chọn được phân cách nhau bằng dấu phẩy.</span>
                                            			</div>
                                            			{{--@endif--}}

                                                        <!-- description -->
                                                        <div class="form-group">
                                                            <label for="description_{{ $customfield['id'] }}">Mô tả trường(field):</label>
                                                            <input id="description_{{ $customfield['id'] }}" name="description" type="text" value="{{ $customfield['description'] }}" placeholder="Nhập mô tả trường(field)" class="form-control" />
                                                        </div>
                                                        <!-- Mandatory -->
                                                        <div class="form-group">
                                                            <div class="checkbox checkbox-success">
                                                                ...
                                                                <label for="req_{{ $customfield['id'] }}" class="text-danger">Trường này là bắt buộc</label>
                                                            </div>
                                                        </div>
                                                        <!-- Search -->
                                                        <div class="form-group {{ ($customfield['options']!='')? '':'hidden' }} search_{{ $customfield['id'] }}">
                                                            <div class="checkbox checkbox-success">
                                                                ...
                                                                <label for="reqs_{{ $customfield['id'] }}" class="text-success">Thêm trường(field) này để tìm kiếm?</label>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="form-group shown_0">
                                                            <div class="checkbox checkbox-success">
                                                                ...
                                                                <label for="shown_{{ $customfield['id'] }}" class="text-success">Thêm trường(field) này để hiển thị trong danh sách quảng cáo?
                                                                    <a href=""  data-toggle="modal" data-target="#modelExample">kiểm tra ví dụ..</a></label>
                                                            </div>
                                                        </div>
                                            		</fieldset>
                                                    <div class="form-group">
                                                        <h5>Chọn các danh mục mà bạn muốn áp dụng thuộc tính:</h5>
                                                    ...
                                                    <div class="form-group">
                                                        <p><a onclick="$('#advance_{{ $customfield['id'] }}').toggleClass('hidden')" href="javascript:void(0)"><b>Tùy chọn nâng cao</b></a></p>
                                                        <div id="advance_{{ $customfield['id'] }}" class="hidden">
                                                            <div class="form-group">
                                                                <label for="">Kiểu dữ liệu</label>
                                                            ...
                                                            <!--  -->
                                                            <div class="form-group">
                                                                <label for="">Ký hiệu(Inscription)</label>
                                                    ...
                                                    <a class="btn btn-default" data-toggle="collapse" data-parent="#accordion1" href="#bg_default_{{ $customfield['id'] }}">Hủy bỏ</a>
                                            	</form>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div id="new_cfield" class="portlet hidden">
                                <div class="portlet-heading bg-info">
                                    <h3 class="portlet-title">Thêm trường(field) mới</h3>
                                    <div class="portlet-widgets">
                                        <a data-toggle="collapse" data-parent="#accordion1" href="#bg_default"><i class="ion-edit"></i></a>
                                        <span class="divider"></span>
                                        <a title="Xóa trường(field)" href="javascript:void(0)" class="delete-cfield" data-id="0"><i class="ion-close-round"></i></a>
                                    </div>
                                    <div class="clearfix"></div>
                                </div>
                                <div id="bg_default" class="panel-collapse collapse">
                                    <div class="portlet-body">
                                        <form name="form" action="#" method="post" enctype="multipart/form-data">
                                            {{ csrf_field() }}
                                                ...
                                                <div class="form-group" id="icon-div_0">
                                                    ...
                                                    <div class="btn-group">
                                                        ...
                                                        <button type="button" onclick="$('#modal_hidden_id').val('0')" class="btn btn-default" value=""  data-toggle="modal" data-target="#iconModal">Thêm Icons</button>
                                                ...
                                                <!-- End icone or image -->
                                                <div class="form-group">
                                                    <label for="name">Tên trường(field):</label>
                                                    <input id="name" name="name" type="text" class="form-control" required />
                                                </div>
                                                <div class="form-group">
                                                    <label for="type">Loại trường(field):</label>
                                                ...
                                                <div class="form-group options_0 hidden">
                                                    <label for="options_{{ '0' }}">Tùy chọn trường:</label>
                                                    <input id="options_{{ '0' }}" name="options" type="text" class="form-control" />
                                                    <span class="help-block">Nhập các tùy chọn được phân cách nhau bằng dấu phẩy.</span>
                                                </div>

                                                <div class="form-group">
                                                    <label for="description_{{ '0' }}">Mô tả trường(field):</label>
                                                    <input id="description_{{ '0' }}" name="description" type="text"  placeholder="Nhập mô tả trường" class="form-control" />
                                                </div>
                                                <div class="form-group">
                                                    <div class="checkbox checkbox-success">
                                                        <input id="req" name="required_field" type="checkbox" value="1">
                                                        <label for="req" class="text-danger">Trường này là bắt buộc</label>
                                                    </div>
                                                </div>
                                                <!-- Search -->
                                                <div class="form-group search_0 hidden">
                                                    <div class="checkbox checkbox-success">
                                                        ...
                                                        <label for="req_0" class="text-success">Thêm trường(field) này để tìm kiếm?</label>
                                                    </div>
                                                </div>
                                                <!-- is shown in search under product  -->
                                                <div class="form-group shown_0">
                                                    <div class="checkbox checkbox-success">
                                                        ...
                                                        <label for="req_0" class="text-success">Thêm trường(field) này để hiển thị trong danh sách quảng cáo?
                                                            <a href=""  data-toggle="modal" data-target="#modelExample">kiểm tra ví dụ..</a></label>
                                                    </div>
                                                </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <p><a onclick="$('#advance').toggleClass('hidden')" href="javascript:void(0)"><b>Tùy chọn nâng cao</b></a></p>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="modelTitleId">Thêm Icon</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3">
                            <div class="form-group search-box">
                                <input type="text" id="search-input" class="form-control product-search" placeholder="Tìm kiếm ở đây ...">
                    ...
                    <div class="card-boxs">
                        ...
                        <section>
                            ...
                            <div class="icon-list-demo row">
                                ...
                                <div class="col-md-2"><i class="fa fa-transgender-alt "></i><span class="hidden"> fa-transgender-alt</span>
                                </div>

                                <div class="col-md-2"><i class="fa fa-user-plus"></i><span class="hidden"> fa-user-plus</span>
                                </div>

                                <div class="col-md-2"><i class="fa fa-user-secret"></i><span class="hidden"> fa-user-secret</span></div>

                                <div class="col-md-2"><i class="fa fa-user-times"></i><span class="hidden"> fa-user-times</span>
                                </div>
                        ...
                        <section id="medical">
                            <div class="row icon-list-demo">
                                ...
                                <div class="col-sm-6 col-md-4 col-lg-3 text-danger" id="no-matching-result">
                                    Rất tiếc, không tìm thấy kết quả phù hợp nào với tên đã tìm.
                                </div>
                            </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="modelTitleId">Ví dụ để mô tả trường</h4>
                </div>
                <div class="modal-body">
