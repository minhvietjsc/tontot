            ...
            <div class="col-xs-12">
                <div class="page-title-box">
                    ...
                    <ol class="breadcrumb p-0 m-0">
                        ...
                        <li class="active"> Cài đặt Email </li>
                    </ol>
                    ...
                    <div class="row">
                        <div class="panel panel-color panel-inverse">
                            <div class="panel-heading">
                                <h3 class="panel-title">Cài đặt Email</h3>
                            </div>
                            <div class="panel-body">
                                <div class="alert alert-info"> Cài đặt Mail </div>
                                ...
                                <div class="col-md-12">
                                    <form class="form-horizontal" role="form" id="email_settings" >
                                        ...
                                        <div class="form-group">
                                            <div class="alert alert-info">Gửi thông báo khi khách đăng ký</div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="alert alert-info">Gửi thông báo khi thay đổi trạng thái</div>
                                        </div>
                                        ...
                                        <!-- Identity Verified  -->
                                        <div class="form-group">
                                            <div class="alert alert-success">Gửi thông báo khi đã xác minh danh tính</div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="alert alert-danger">Gửi thông báo khi danh tính chưa được xác minh</div>
                                        </div>
                                      ...
                                      <!-- Expiry  -->
                                        <div class="form-group">
                                            <div class="alert alert-danger"> Gửi thông báo khi quảng cáo hết hạn </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <button class=" pull-right btn w-md btn-bordered btn-success waves-effect waves-light" type="submit">Lưu</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                ...
                $.ajax({
                    ...
                    success: function(result){
                        ...
                        if(result == '1'){
                            swal({
                                title: "Success!",
                                text: "Cài đặt email đã được lưu thành công!",
                                type: "success",
