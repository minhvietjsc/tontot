        ...
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"><i
                    ...
                    <h4 class="modal-title">Thêm/Sửa Tài khoản</h4></div>
                    <form id="add_category" method="post" role="form"><input type="hidden" name="id" value="" id="id">
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group"><label for="">Tiêu đề:</label> <input type="text" name="title"
                                        class="form-control"
                                        value="" id="name"
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group"><label for="">Danh mục:</label> <select name="category" id=""
                                            class="form-control">
                                            <option value="0">Danh mục cha</option> @foreach($cat as $value){
            ...
            function buildCategory($parent, $category)
            {
                ...
                if (isset($category['parent_cats'][$parent])) {
                    ...
                    if (!isset($category['parent_cats'][$cat_id])) {
                        $html .= "<li class='no_child connected '>
