                    ...
                    <div class="row">
                        <div class="col-xs-7 bg-white product-listing">
                            ...
                            <form id="add_category" method="post" role="form" enctype="multipart/form-data">
                                ...
                                @endif
                                <input type="hidden" name="id" value="{{ ( isset($model) && $model->id != '')? $model->id: '' }}" id="id" >
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="">Tiêu đề:</label>
                                                <input type="text" name="name" class="form-control" value="{{ ( isset($model) && $model->name != '')? $model->name: '' }}" id="title" placeholder="Tiêu đề Danh mục" required >
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <div class="radio radio-info radio-inline">
                                                    ...
                                                    <label for="is_icon">Thêm Icon</label>
                                                </div>
                                                <div class="radio radio-inline">
                                                    <input type="radio" id="is_image" value="option2" name="switch">
                                                    <label for="is_image">Thêm ảnh </label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row" id="icon-div">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="btn-group">
                                                    <button type="button" class="btn btn-default" value="" data-toggle="modal" data-target="#iconModal">Thêm Icons</button>
                                                    <button type="button" id="myicon" class="btn btn-primary {{ ($icon =='')? 'hidden' : '' }}"><?= ($icon !='')? '<i class="'.$icon.'"></i>' : '' ?></button>
                                                    <input type="hidden" name="icon" value="{{ ( isset($model) && $model->icon != '')? $model->icon: '' }}" id="icon_val" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="category" id="category" class="form-control">
                                                    ...
                                                    <option <?= ( isset($model) && $model->parent_id == $value['id'])? 'selected': ''; ?> value=" <?= $value['id']; ?>"> <?= $value['name'] ?></option> 
                                                  <!--  <option <?= ( isset($model) && $model->parent_id == $value['id'] && $value['parent_id']!=0 )? 'selected': ''; ?> value=" <?= $value['id']; ?>"> <?= $value['name'] ?></option> -->
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label class="control-label">Tùy chọn giá</label>
                                                <input type="text" name="price" value="{{ ( isset($model) && $price_option != '')? $price_option: '' }}" class="form-control" placeholder="năm,tháng,tuần,ngày">
                                                <small> vui lòng thêm các giá trị được phân tách nhau bằng dấu phẩy</small>
                                            </div>
                                        </div>
                                    </div>
                ...
                $.ajax({
                    ...
                    success: function(result){
                        ...
                        if( data.msg == 'success' ){
                            ...
                            swal("Success!", "Lưu danh mục thành công.", "success");
