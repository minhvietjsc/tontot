                                    ...
                                    @if(count($page) > 0)
                                        @foreach($page as $value)
                                            <li class="list-group-item" id="{{$value->id}}">
                                                ...
                                                {{ $value->title }}
                                                <button data-toggle="tooltip" title="Xóa" class="btn btn-xs btn-danger pull-right" onclick="deleteRow(this)" data-id="{{$value->id}}" data-obj="custom_page"> <i class="fa fa-trash"></i> </button>
                                                <a href="{{route('custom-page.edit', $value->id)}}" data-toggle="tooltip" title="Sửa" class="btn btn-xs btn-primary pull-right m-r-5"> <i class="fa fa-pencil"></i> </a>
                                            </li>
                                        @endforeach
                                    @endif
                                </ul>
