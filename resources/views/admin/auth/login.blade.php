                            ...
                            <form class="form-horizontal" method="POST" action="{{ route('admin-login.store') }}">
                                ...
                                <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <input class="form-control" type="password" placeholder="Mật khẩu" name="password" value="{{ old('password') }}">
                                ...
                                <div class="form-group account-btn text-center m-t-10">
                                    ...
                                    <div class="col-xs-12">
                                        ...
                                        <button class="btn w-md btn-bordered btn-danger waves-effect waves-light" type="submit">Đăng nhập</button>
