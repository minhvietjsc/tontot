           ...
           <div class="col-md-6 col-md-offset-4 login-box">
                <div class="panel panel-default" style="background-color: #f5f5f5">
                    <div class="text-center">
                        <h2 class="logo-title m-t-20"> Liên hệ với chúng tôi </h2>
                    </div>
                    <hr>
                    @if (session('success'))
            ...
            <div class="form-group">
                <button class="btn btn-danger btn-lg" onclick="$('.fa-spinner').removeClass('hidden')"><i class="fa fa-send"></i> Gửi <i class="fa fa-spinner fa-spin hidden"></i> </button>
            </div>
        </form>
                    </div>
                </div>
