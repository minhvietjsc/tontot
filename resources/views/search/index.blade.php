...
<ul>
  ...
  <?php 
    foreach ($parent_cat as $key=>$value){ 
      // echo '<li><a href="'.$key.'">'.$value['cat']["name"].'</a></li>';
                ...
                <div class="col-sm-3 page-sidebar mobile-filter-sidebar">
                    <aside>
                        <div class="row inner-box">
                            ...
                            <div class="form-group">
                                    <label for="sortbyprice" class=" control-label">Sắp xếp theo Tỉnh/Thành Phố</label>
                                    ...
                                    <!--     <option value="asc">Giá từ Thấp đến Cao</option>
                                        <option value="desc"> Giá từ Cao xuống Thấp </option> -->
                                         <?php 
                                          ...
                                          echo '<option value=@@>'.$city['title'].'</option>';
                                              } 
                                          ?>
                                    </select>
                            </div>
                                ...
                                <div class="form-group">
                                    <label for="sortbyprice" class=" control-label">Sắp xếp theo Giá</label>
                                    <select name="price_order" class="form-control price_sort_select" onchange="$('#price_sort').val($(this).val())">
                                        <option value=""></option>
                                        <option value="asc">Giá từ Thấp đến Cao</option>
                                        <option value="desc"> Giá từ Cao xuống Thấp </option>
