            ...
            <div class="row">
                <div class="col-sm-9 page-content col-thin-right">
                    <div class="inner inner-box ads-details-wrapper">
                        <h1 class="auto-heading" style="padding-right: 0;">
                        	<span class="auto-title left col-sm-8 text-left"> {{ ucfirst($data->title) }} </span>
                            @if($setting->hide_price == 0)
                            <span class="auto-price col-sm-4 text-right"> {{ $setting->currency_place == 'left' ? $setting->currency : ''  }}{{ number_format($data->price) }} {{  $setting->currency_place == 'right' ? $setting->currency : ''  }}  {{ ($data->price_option!='')? '/'.$data->price_option : '' }} </span>
                            @endif
                        </h1>
                        ...
                        <div class="row ">
                            ...
                            <div class="col-md-12 m-b-20">
                                ...
                                <div class="content-footer text-left m-t-20">
                                    ...
                                    <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#contactModalId"> <i class="fa fa-envelope-o" aria-hidden="true"></i> Liên hệ </button>
                                    <a @if($data->user->mobile_verify == 1) title="Đã xác minh điện thoại" @endif id="Mobile_Contact" data-toggle="modal" data-target="#showPhone" class="btn  btn-info btn-lg" onclick="$('#phone_hide').addClass('hidden'); $('#phone_show').removeClass('hidden');"><i class=" icon-phone-1"></i> <span id="phone_hide">Hiển thị số điện thoại</span>
                                    ...
                                    ?>
                                        @if( $data->user->id != Auth::user()->id && $data->user->is_login == 1 && $is_locked =='' )
                                            <button  class="btn btn-default btn-lg chathead" data-for="{{ $data->user->id }}"><i class=" icon-chat"></i> Nói chuyện bây giờ </button>
                                        @endif
                                    @endif
                                </div>
                                <div class="clearfix"></div>
                ...
                <div class="col-sm-3  page-sidebar-right">
                    <aside>
                        <div class="panel sidebar-panel panel-contact-seller">
                            <div class="panel-heading">{{ ( $data->user->type == 'c' )? 'Liên hệ đại lý' : 'Liên hệ người dùng' }}</div>
                            <div class="panel-content user-info">
                                <div class="panel-body p-0">
                                    <div class="seller-info" style="position: relative">
                                        ...
                                        {{-- <a href="{{ url('user-ads', $data->user->id) }}" class="btn btn-primary btn-block m-t-5"> <i class=" fa fa-user"></i> Nhiều quảng cáo hơn với người dùng này </a> --}}
