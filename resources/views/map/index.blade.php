...
<div class="main-container m-t-30">
    <div class="container">
        <div class="row">
           <div class="col-md-12">
                   <h4 class="card-title"><b>Tìm kiếm vị trí để xem danh sách</b></h4>
               <div class="form-group">
                   <input id="pac-input" type="text" class="form-control controls" placeholder="Tìm kiếm vị trí">
               </div>
                ...
                (function (marker, data) {
                    google.maps.event.addListener(marker, "click", function (e) {
                        ...
                        infoWindow.setContent('<div id="iw-container">' +
                            ...
                            '<div class="iw-subTitle">Mô tả @if(DB::table('setting')->value('hide_price') == 0) <span class="pull-right">'+data.price+'</span> @endif </div>' +
