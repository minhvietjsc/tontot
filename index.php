...
if(!version_compare(phpversion(), '7', '>=')) {
    $err[]= 'Required php version <strong style="color:green">7</strong> or above. Your current php version is <strong style="color:red"> ' . phpversion() . ' </strong>  please update php version to install nimble classified application.';
}
...
<div class="master">
    <div class="box">
        ...
        <div class="main">
            ...
            <?php
            echo '<h2> Please Fix following server errors to install Nimble Ads Application </h2>';
            echo '<ol>';
            foreach ($err as $val) {
                echo '<li>' . $val . '</li>';
            }
